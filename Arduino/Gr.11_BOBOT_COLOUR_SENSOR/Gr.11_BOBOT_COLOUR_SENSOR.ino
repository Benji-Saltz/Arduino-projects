...
//By: Benji Saltz
//Description: BOBOT MOVES WHEN IT SENSES RED, GREEN AND BLUE
...
{   
  ...
  delay(100);
  digitalWrite(redPinOn, LOW); //write low to all the colour pins
...
Serial.println();  
  ...
  {  
digitalWrite(redPinOn, HIGH); //write high to red colour 
Serial.println(redPinOn); //print red pin
 ...
 digitalWrite(greenPinOn, HIGH);  //write high to green colour
